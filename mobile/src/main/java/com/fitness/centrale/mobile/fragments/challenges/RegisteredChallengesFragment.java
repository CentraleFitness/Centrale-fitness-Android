...
public class RegisteredChallengesFragment extends Fragment {
    ...
    public void refreshEvents(){
        ...
        if (Store.getStore().getDemoObject().demo){
            ...
            for (DemoObject.Event event : Store.getStore().getDemoObject().getRegisteredEvents()){
                BasicChallengeObject obj = new BasicChallengeObject(event.id, event.name, getContext());
                obj.event = event;
                    ...
                    if (response.getString("code").equals("001")){
                        ...
                        while (index != events.length()){
                            ...
                            if (subArray.getBoolean(2))
                                itemsIdsList.add(new BasicChallengeObject(subArray.getString(1), subArray.getString(0), getContext()));
    ...
    public static RegisteredChallengesFragment newInstance() {
        RegisteredChallengesFragment fragment = new RegisteredChallengesFragment();
